...
Phase 1 — Foundation is implemented. Phase 2A adds provider-independent Market Data dataset identity and deterministic canonical-candle sequence validation. Phase 2B1 adds a single-page Binance Spot historical-kline infrastructure adapter and normalizer. Historical ingestion, pagination, storage, trading, evaluation, and live market data are intentionally not implemented yet.
